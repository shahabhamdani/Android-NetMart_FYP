...
public class FilterProductsListings extends Filter {

    private AdapterProductsListings adapter;
    private ArrayList<ModelProduct> filterList;

    public FilterProductsListings(AdapterProductsListings adapter, ArrayList<ModelProduct> filterList) {
