...
public class AdapterProductsListings extends
    ...
    private void showQuantityDialog(ModelProduct modelProduct) {
        ...
        View view = LayoutInflater.from(context).inflate(R.layout.dialog_quantitiy, null);
        //init layout views
    ...
    private void addToCart(String productId, String title, String priceEach, String totalPrice, String price,  String quantity) {
        itemId++;
